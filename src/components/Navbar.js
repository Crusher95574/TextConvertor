...
{/*<div className={`form-check form-switch text-${props.mode==='red'?'red':'white'}`}>
  <input className="form-check-input" onClick={props.toggleMode} type="checkbox" role="switch" id="flexSwitchCheckDefault" />
...
<div className={`form-check form-switch text-${props.mode==='light'?'purple':'white'}`}>
  <input className="form-check-input" onClick={props.toggleMode} type="checkbox" role="switch" id="flexSwitchCheckDefault" />
...
Navbar.proptype={title: PropTypes.string.isRequired,aboutText: PropTypes.string.isRequired}
